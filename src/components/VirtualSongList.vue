<template>
  <div ref="containerRef" class="vl-container an-enter" :class="{ 'vl-container--parent-scroll': scrollHostSelector }" @scroll="onScroll">
    <!-- 表头 -->
    ...
    <div class="vl-body" :style="{ height: `${totalHeight}px` }">
      ...
      >
        ...
        <span class="local-song-cover">
          <img v-if="vi.track.coverUrl" :src="vi.track.coverUrl" class="local-cover-img hover-scale-image" alt="" loading="lazy" />
